      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Building the future of voice AI for developers to create intelligent and responsive voice experiences.
            </p>
        ...
        <div className="border-t border-border/50 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <select className="text-sm bg-transparent border border-border rounded-md p-1">
