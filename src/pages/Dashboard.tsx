...
import { Menu, ChevronDown, ExternalLink, Play, MessageSquare, PenTool, Phone, Bot, Volume2, Mic, Key, BarChart, TrendingUp, Users, Zap, Activity, ArrowUp, ArrowDown } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-background text-foreground">
      ...
      <div className="flex-1 p-4 sm:p-6 overflow-auto">
        <div className="mb-6 sm:mb-8 animate-fade-in">
          <h1 className="text-2xl sm:text-3xl font-bold mb-1 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Welcome to Your Dashboard</h1>
        ...
        <div className="mb-6 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20 transition-all duration-500 hover:shadow-md hover:shadow-primary/5 group">
          ...
          <Card className="bg-gradient-to-br from-secondary/10 to-secondary/5 border-secondary/20 transition-all duration-500 hover:shadow-md hover:shadow-secondary/5 group">
            <CardContent className="p-4 flex flex-col items-center justify-center">
          ...
          <Card className="bg-gradient-to-br from-accent/10 to-accent/5 border-accent/20 transition-all duration-500 hover:shadow-md hover:shadow-accent/5 group">
            <CardContent className="p-4 flex flex-col items-center justify-center">
          ...
          <Card className="bg-gradient-to-br from-primary/10 to-accent/5 border-primary/20 transition-all duration-500 hover:shadow-md hover:shadow-primary/5 group">
            <CardContent className="p-4 flex flex-col items-center justify-center">
              <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
        ...
        <div className="mb-8 animate-fade-in" style={{ animationDelay: "100ms" }}>
          <h2 className="text-xl font-semibold mb-4 px-1 flex items-center">
            <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Campaign Performance</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card className="border-l-4 border-l-primary transform transition-transform hover:scale-[1.01] hover:shadow-md overflow-hidden group relative">
            ...
            <Card className="border-l-4 border-l-secondary transform transition-transform hover:scale-[1.01] hover:shadow-md overflow-hidden group relative">
            ...
            <Card className="border-l-4 border-l-accent transform transition-transform hover:scale-[1.01] hover:shadow-md overflow-hidden group relative">
        ...
        <div className="mb-6 animate-fade-in" style={{ animationDelay: "200ms" }}>
          <h2 className="text-xl font-semibold mb-4 px-1 flex items-center">
            <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Quick Actions</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <Card className="bg-gradient-to-r from-background to-muted/30 hover:shadow-md transition-shadow group relative overflow-hidden border border-muted">
            ...
            <Card className="bg-gradient-to-r from-background to-muted/30 hover:shadow-md transition-shadow group relative overflow-hidden border border-muted">
              ...
              <CardFooter className="pt-2">
                <Button size="sm" className="w-full group-hover:bg-secondary/90" asChild>
            ...
            <Card className="bg-gradient-to-r from-background to-muted/30 hover:shadow-md transition-shadow group relative overflow-hidden border border-muted">
              ...
              <CardFooter className="pt-2">
                <Button size="sm" className="w-full group-hover:bg-accent/90" asChild>
        ...
        <div className="mb-6 animate-fade-in" style={{ animationDelay: "300ms" }}>
          <h2 className="text-xl font-semibold mb-4 px-1 flex items-center">
            <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Recent Activity</span>
          </h2>
            ...
            <CardContent className="p-0">
              <div className="divide-y">
                {[
                  ...
                  <div key={idx} className="flex items-center px-4 py-3 hover:bg-muted/40 transition-colors">
                    <div className={`
